  ...
  return (
    <main className={`container-options`}>
        <div className='contaier-options_div' onMouseEnter={() => handleMouseEnter(1)} onMouseLeave={handleMouseLeave}>
            <img className={`${enter == 1? 'select-on' : 'select-off'}`} src='/arrows-up-and-down-pixelated-art-design-for-game-vector.png'></img>
        ...
        <div className='contaier-options_div' onMouseEnter={() => handleMouseEnter(2)} onMouseLeave={handleMouseLeave}>
            <img className={`${enter == 2? 'select-on' : 'select-off'}`} src='/arrows-up-and-down-pixelated-art-design-for-game-vector.png'></img>
        ...
        <div className='contaier-options_div' onMouseEnter={() => handleMouseEnter(3)} onMouseLeave={handleMouseLeave}>
            <img className={`${enter == 3? 'select-on' : 'select-off'}`} src='/arrows-up-and-down-pixelated-art-design-for-game-vector.png'></img>
