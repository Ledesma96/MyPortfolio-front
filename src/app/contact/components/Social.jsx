            ...
            <section className='container-contact_div_div_section'>
                <div className='container-contact_div_div_section_div'>
                    <Link className='link' href='https://github.com/Ledesma96' target='blank'>
                        <img className='container-contact_div_div_section_div_img' src='/ejry4wslmps91.png' alt='github logo'></img>
                ...
                <div className='container-contact_div_div_section_div'>
                    <Link className='link'  href='https://www.linkedin.com/in/gabriel-matias-ledesma/' target='blank'>
                        <img  className='container-contact_div_div_section_div_img' src='/linkedin_pixel_logo_icon_181925.png' alt='linkedin logo'></img>
                ...
                <div className='container-contact_div_div_section_div'>
                    <Link className='link'  href="mailto:gabriel.m.ledesma96@gmail.com">
                        <img className='container-contact_div_div_section_div_img' src='/mail-letter-pixel-free-vector.png' alt='email logo'></img>
